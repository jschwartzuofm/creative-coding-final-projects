...
Promise.all([
  ...
  svg.append('g')
    ...
    .enter().append('path')
      ...
      .on('mouseover', (e, d) => {
        ...
        const strokeCol = d.properties.mhIncome > 79713 ? 'red' : 'black';  //median income in NYC is 79,713
  ...
  const legendX = w - legendWidth - 40;
...
const noteX = legendX - 450;               // move 150px left of legend
const noteY = legendY + legendHeight + 100; 
